<template>
      ...
      >
        ...
        <a href="#" class="block sm:hidden" aria-label="Banner Link">
          <img
            ...
            class="w-full h-[220px] xs:h-[250px] object-cover m-0 p-0 block"
            style="display:block;margin:0;padding:0;"
          />
        </a>
    ...
    <section class="w-full mx-auto">
      ...
      >
        ...
        />
        <div class="absolute inset-0 bg-gradient-to-t from-purple-900/70 via-purple-700/40 to-transparent"></div>
